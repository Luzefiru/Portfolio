  ...
  return (
    <section className="Hero">
      <div className="Hero__left">
        ...
        <ul className="Hero__left__contacts" aria-label="Contact List">
          <li>
            <a
              aria-label="New Tab - LinkedIn"
              href="https://www.linkedin.com/in/christiandejesusiv/"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="Hero__decor-text">ゼフィル</div>
    </section>
  );
}
